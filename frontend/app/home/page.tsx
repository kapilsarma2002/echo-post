        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <form onSubmit={handleSearch} className="hidden md:flex bg-gray-100 rounded-md px-3 py-2 items-center space-x-2 w-64">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-8">
          ...
          <div className="mt-4 md:mt-0 flex space-x-3">
            ...
            <Button onClick={handleSettings} variant="outline" className="flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-lg font-semibold text-gray-800">Upcoming Posts</h2>
                <Button onClick={handleViewAllPosts} variant="ghost" size="sm">View All</Button>
              </div>
              ...
              <Button onClick={handleViewAllPosts} variant="outline" className="w-full mt-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <Button onClick={handleDetailedAnalytics} variant="outline" className="w-full mt-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="font-medium text-gray-800">Create Text Post</span>
                </button>
                ...
                >
                  ...
                  <span className="font-medium text-gray-800">View Published</span>
                </button>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="w-5 h-5 flex items-center justify-center text-blue-800 mr-3 font-bold text-sm">Li</div>
